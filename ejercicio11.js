...
for (const user of users) {
   for (const use in user.favoritesSounds) {
     totalVolumen += user.favoritesSounds[use].volume;
     count++
   }
}
const volumen = totalVolumen / count
...
//   console.log("Lista de elementos y sus conteos:");
//   for (var clave in conteo) {
//     console.log(clave + ": " + conteo[clave]);
//   }
// }

// var array = ["a", "b", "c", "a", "b", "c", "a", "b", "c", "d"];
